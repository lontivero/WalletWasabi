...
namespace WalletWasabi.Tests.UnitTests.WabiSabi.Client
{
	public class CredentialDependencyTests
	{
		...
		{
			Assert.Throws<ArgumentException>(() => DependencyGraph.ResolveCredentialDependencies(new long[][] { new[] { -1L, 0L } }));
			Assert.Throws<ArgumentException>(() => DependencyGraph.ResolveCredentialDependencies(new long[][] { new[] { 1L, 0L }, new[] { -2L, 0L } }));
			Assert.Throws<ArgumentException>(() => DependencyGraph.ResolveCredentialDependencies(new long[][] { new[] { 1L, 0L }, new[] { -1L, -1L } }));
